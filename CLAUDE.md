...
section ("MAJOR UPDATE 14 — hero reveal RESET to the simplest possible
version"), which is a current, accurate summary of what's built and how
it works. Earlier sections in that
